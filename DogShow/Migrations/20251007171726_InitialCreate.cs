        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AcquisitionPlace = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompetitionJudge", x => new { x.CompetitionId, x.JudgeId });
                    table.ForeignKey(
                        name: "FK_CompetitionJudge_Competitions_CompetitionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompetitionJudge_JudgeId",
